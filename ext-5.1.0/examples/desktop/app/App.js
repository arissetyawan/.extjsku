...
//        'Desktop.Blockalanche',
    ...
    getDesktopConfig: function () {
        ...
        return Ext.apply(ret, {
            ...
            shortcuts: Ext.create('Ext.data.Store', {
                ...
                data: [
                    { name: 'Daftar Nilai', iconCls: 'grid-shortcut', module: 'grid-win' }/*,
            ...
            wallpaper: 'resources/images/wallpapers/Wood-Sencha.jpg',
        ...
        return Ext.apply(ret, {
            quickStart: [
               // { name: 'Accordion Window', iconCls: 'accordion', module: 'acc-win' },
                { name: 'Daftar Nilai Kelas Pemrograman Komputer 1 - Java SDK', iconCls: 'icon-grid', module: 'grid-win' }
            ],
            trayItems: [
    ...
    onLogout: function () {
        Ext.Msg.confirm('Logout', 'Yakin ingin keluar dari aplikasi ?');
    },
